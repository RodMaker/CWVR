...
public class ToggleParticle : MonoBehaviour
{
    ...
    private SphereCollider currentSphereCollider = null; // Added this line

    private void Awake()
    {
        currentParticleSystem = GetComponent<ParticleSystem>();
        currentSphereCollider = GetComponent<SphereCollider>(); // Added this line
    }

    public void Play()
    {
        currentParticleSystem.Play();
        currentSphereCollider.enabled = true; // Added this line
    }

    public void Stop()
    {
        currentParticleSystem.Stop();
        currentSphereCollider.enabled = false; // Added this line
    }
